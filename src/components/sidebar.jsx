        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Yongrui(Samuel) Su</a></h1>
              <span className="email"><i className="icon-mail"></i> sam.ysu.uc@gmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
				<li><a href="https://www.linkedin.com/in/samuel-yongrui-su-b2108627/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
				  {/*
